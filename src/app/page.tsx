...
export default function Home() {
  return (
    <div className="prose prose-norwegian dark:prose-invert max-w-none">
      ...
      <p className="mt-6">
        <Link href="/projects" className="inline-block rounded border px-4 py-2 no-underline btn btn--neon">See projects</Link>
        <Link href="/blog" className="ml-4 inline-block rounded border px-4 py-2 no-underline btn btn--neon">Read blog</Link>
      </p>
    </div>
  );
}
