...
export default function Home() {
  return (
    <div className="prose prose-norwegian dark:prose-invert max-w-none">
      ...
      <p className="text-lg">A Software Engineer focused on building reliable, scalable web apps and developer tools. This site showcases projects, writing, and technical demos.</p>
