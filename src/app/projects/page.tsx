...
const curatedFallback: Repo[] = [
    ...
    },
    {
        ...
        description:
            'This website: Next.js + TypeScript + Tailwind + MDX (Contentlayer).',
            ...
            <div className="space-y-1">
                {repos.map((r) => (
                    <a
                        ...
                        title={r.name}
                        className="group flex items-center gap-3 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[var(--color-fjord-600)]"
                    >
                        <div className="w-24 flex-shrink-0 min-w-0 md:w-32 lg:w-40">
                            <span
                                className="block w-full rounded-lg px-3 py-2 no-underline btn btn--primary btn--glass normal-case text-sm font-medium tracking-normal overflow-hidden text-center shadow-sm hover:shadow-md transition-transform transition-shadow duration-150 ease-out transform-gpu motion-safe:hover:-translate-y-0.5 active:scale-95 active:translate-y-0 dark:shadow-[0_6px_18px_rgba(0,0,0,0.6)] dark:hover:shadow-[0_10px_28px_rgba(0,0,0,0.7)]"
                                aria-hidden="true"
                            >
                        ...
                        <div className="flex-1 flex items-center min-w-0">
                            <span
                                className="mr-3 inline-block w-[2px] h-6 rounded bg-gradient-to-b from-[var(--color-norwegian-400)] to-[var(--color-fjord-600)] opacity-0 transition-opacity duration-200 group-hover:opacity-100 motion-reduce:transition-none"
                                aria-hidden="true"
                            />
                            <p className="text-sm leading-relaxed text-[var(--color-norwegian-700)] opacity-90 transition duration-200 transform group-hover:-translate-y-0.5 group-hover:shadow-[0_6px_18px_rgba(64,215,208,0.04)] group-hover:opacity-100 motion-reduce:transition-none cursor-pointer">
                                {r.description ?? ''}
                            </p>
                        </div>
                    </a>
