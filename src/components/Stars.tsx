                ...
                {Array.from({ length: 5 }).map((_, i) => {
                    ...
                    if (scaled >= fullThreshold) {
                        return (
                            <svg
                                key={i}
                                className={`h-5 w-5 text-[var(--color-norwegian-400)]`}
                                viewBox="0 0 20 20"
                                fill="currentColor"
                            ...
                            >
                                <defs>
                                    <linearGradient id={gradId} x1="0" x2="1">
                                        <stop
                                            offset="50%"
                                            stopColor="var(--color-norwegian-400)"
                                        />
                                        <stop
                                            offset="50%"
                                            stopColor="var(--color-norwegian-200)"
                                        />
                                    </linearGradient>
                                </defs>
                                ...
                                <path
                                    fill={`url(#${gradId})`}
                                    d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.286 3.955a1 1 0 00.95.69h4.162c.969 0 1.371 1.24.588 1.81l-3.37 2.448a1 1 0 00-.364 1.118l1.287 3.955c.3.921-.755 1.688-1.54 1.118L10 13.347l-3.37 2.448c-.784.57-1.838-.197-1.54-1.118l1.287-3.955a1 1 0 00-.364-1.118L2.644 9.382c-.783-.57-.38-1.81.588-1.81h4.162a1 1 0 00.95-.69L9.049 2.927z"
                                />
                            </svg>
                        );
                    }
                    ...
                    return (
                        <svg
                            key={i}
                            className={`h-5 w-5 text-[var(--color-norwegian-200)]`}
                            viewBox="0 0 20 20"
                            fill="currentColor"
                            xmlns="http://www.w3.org/2000/svg"
                            aria-hidden
